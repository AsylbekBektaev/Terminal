...
define('SERVICE_NAME', '400-400 ТАКСИ ТАЛДЫКОРГАН');
...
<script src="/js/jquery.mask.min.js"></script><script src="/js/LoadingPage.js"></script><script src="/js/LoadingPage.js"></script>
