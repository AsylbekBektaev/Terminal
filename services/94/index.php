...
define('SERVICE_LOGO','beeline.png');

define('SERVICE_NAME', 'Билайн');
...
?><section class="body service">
    <ul class="inputs fs0">
        <li>
            ...
            <div class="input" data-mask="<?php echo SERVICE_MASK; ?>" data-type="number" data-length="15" style="min-width: 400px;435px;"></div>
