...
define('SERVICE_LOGO','jetisuenergotreid.png');

define('SERVICE_NAME', 'Жетысу Энерготрейд');
...
?><section class="body service">
    <ul class="inputs fs0">
        <li>
            <div class="info" data-lang="enter_phone_number">Введите номер счета</div>
            <div class="input" data-mask="<?php echo SERVICE_MASK; ?>" data-type="number" data-length="19" style="min-width: 500px;"></div>
        </li>
    </ul>
</section>
