...
define('SERVICE_NAME', 'Indigo24 әмиян');

define('SERVICE_MASK', '7 ### ### ## ##');
...
?><section class="body service">
    <ul class="inputs fs0">
        <li>
            ...
            <div class="input" data-mask="<?php echo SERVICE_MASK; ?>" data-type="number" data-length="15" style="min-width: 517px;435px;"></div>
...
<footer class="service">
    ...
    <a class="button forward fr" data-lang="next" data-href="confirm.php" onclick="check();">next</a>
</footer><?php
...
Storage.set('TOK', result.tokenID);
                ...
                if (result.data) {
                    Storage.SaveObLocal('data', result.data);
                }
